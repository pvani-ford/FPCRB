...
app = dash.Dash(__name__,suppress_callback_exceptions=True, external_stylesheets=[dbc.themes.FLATLY],title="FPCRB",
...
def render_page_content(pathname):
    if pathname == "/":
        ...
        dbc.Col([
             ...
             html.Hr(className="my-2"),
             html.P([
                    "You can use this dashboard to perform the following activities",
                     html.Br(),
                    "1.)  Summary of FordPass mobile app user sentiment for Android & iOS platforms",
                     html.Br(),
                    "2.) Filter and extract customer feedback using following filters",
                     html.Br(),
    ...
    html.Div(id='home-Overall')]
        ...
        [ 
            ...
            html.Hr(className="my-2"),
            html.P(
                "what user think of FordPass ? Click on each Labels to know their sentiment."
            ),
            html.Div(
        [
            dbc.ButtonGroup(
...
def homeCard(btn1,country,version,start_date,end_date):
    ...
    if start_date and end_date:
        if "btn-home" == ctx.triggered_id:
            ...
            neuCount = data[data['sentiment'] == 'Mixed'].shape[0]
...
if __name__ == '__main__':
    app.run_server(host="19.199.84.202",port=8099,use_reloader=False)