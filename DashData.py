...
def send_mail():
    ...
    msg = outlook.make(
        ...
        with_properties={
            k.subject: 'FordPass Customer Feedback- Android & iOS',
            k.plain_text_content: """
                        ...
                        <tbody>
                          <tr style="box-sizing:border-box">
                            ...
                            <td align="right" style="border-collapse:collapse; box-sizing:border-box; padding:0 0 40px">
                              ...
                              <h2 style="color:#000; font-size:25px; font-weight:400; box-sizing:border-box; margin:5px 0 0; padding:0">"""+email_date_format+"""</h2>
                            </td>
                          </tr>
                          <tr style="box-sizing:border-box">
                                    ...
                                    <tbody style="box-sizing:border-box">
                                      <tr style="box-sizing:border-box">
                                        ...
                                        <td class="x_x_card-open-link" align="right" valign="top" style="border-collapse:collapse; box-sizing:border-box; white-space:nowrap; padding:20px 10px">
                                          <a href="http://19.199.84.202:8099/" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none" data-safelink="true" data-linkindex="2">Open in Dashboard(Ford VPN)</a> 
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody style="box-sizing:border-box">
                                      <tr style="box-sizing:border-box">
                                        <td style="width:70px; border-collapse:collapse; box-sizing:border-box">
                                          <div class="x_x_grade-container" align="center" style="background-color:#088508; box-sizing:border-box; width:30px; height:30px; border-radius:24px; margin-left:10px; margin-top: 10px; padding:0">
                                            <span class="x_x_grade" style="box-sizing:border-box; line-height:30px; color:#FFF; font-size:15px; font-weight:400">"""+str(positiveCount)+"""</span>
                                          </div>
                                          <div class="x_x_grade-container" align="center" style="background-color:#FFA500; box-sizing:border-box; width:30px; height:30px; border-radius:24px; margin-left:10px; margin-top: 10px;padding:0">
                                            <span class="x_x_grade" style="box-sizing:border-box; line-height:30px; color:#FFF; font-size:15px; font-weight:400">"""+str(mixedCount)+"""</span>
                                          </div>
                                          <div class="x_x_grade-container" align="center" style="background-color:#FF5D48; box-sizing:border-box; width:30px; height:30px; border-radius:24px; margin-left:10px; margin-top: 10px;padding:0">
                                            <span class="x_x_grade" style="box-sizing:border-box; line-height:30px; color:#FFF; font-size:15px; font-weight:400">"""+str(negativeCount)+"""</span>
                                          </div>
                                        </td>
                                        <td style="border-collapse:collapse; box-sizing:border-box">
                                          ...
                                          <div class="x_x_sentiment-sentence" style="box-sizing:border-box; margin-top:20px; font-weight:400">
                                            <span class="x_x_sentiment-same" style="box-sizing:border-box">Mixed Reviews</span>
                                          </div>
                                          <div class="x_x_sentiment-sentence" style="box-sizing:border-box; margin-top:20px; font-weight:400">
                                        ...
                                        <td class="x_x_numeric-stat-box" align="left" style="border-collapse:collapse; box-sizing:border-box; border-left-width:2px; border-left-color:#E9E9EB; border-left-style:solid; padding-left:20px; width:25%">
                                          ...
                                          <div class="x_x_review-statistic-large" style="box-sizing:border-box; margin-top:5px">
                                            <span class="x_x_numeric-actual" style="box-sizing:border-box; font-size:20px; font-weight:400">"""+str(totalCount)+"""</span> 
                                          </div>
                                        </td>
                                        <td class="x_x_numeric-stat-box" align="left" style="border-collapse:collapse; box-sizing:border-box; border-left-width:2px; border-left-color:#E9E9EB; border-left-style:solid; padding-left:20px; width:25%">
                                          ...
                                          <div class="x_x_review-statistic-large" style="box-sizing:border-box; margin-top:5px">
                                            <span class="x_x_numeric-actual" style="box-sizing:border-box; font-size:20px; font-weight:400">"""+str(avgRating)+"""</span> 
                                          </div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  <div class="x_x_breakdowns" style="box-sizing:border-box; border-radius:6px; margin:0 5px; padding:8px 0">
                                    <table style="box-sizing:border-box; table-layout:fixed;background-color:#F9F9F9;">
                                      <tbody style="box-sizing:border-box">
                                        <tr style="box-sizing:border-box">
                                        ...
                                        <tr style="box-sizing:border-box">
                                          <td rowspan="3" class="x_x_content-cell x_x_breakdown-cell" valign="top" style="border-collapse:collapse; box-sizing:border-box; font-size:10px; font-weight:500; line-height:20px; width:1%; white-space:nowrap; padding:0 10px 0 10px">
                                            <div style="box-sizing:border-box">
                                              ...
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span> 
                                              <span class="x_x_topic" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none; margin-left:10px">"""+str(star_5)+"""</span> 
                                            </div>
                                            <div style="box-sizing:border-box">
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              ...
                                              <span class="x_x_topic" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none; margin-left:10px">"""+str(star_4)+"""</span> 
                                            </div>
                                            <div style="box-sizing:border-box">
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              ...
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span>
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span> 
                                              <span class="x_x_topic" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none; margin-left:10px">"""+str(star_3)+"""</span> 
                                            </div>
                                            <div style="box-sizing:border-box">
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              ...
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span>
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span> 
                                              <span class="x_x_topic" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none; margin-left:10px">"""+str(star_2)+"""</span>
                                            </div>
                                            <div style="box-sizing:border-box">
                                              <span class="x_x_star-on" style="box-sizing:border-box; font-size:14px; color:#F3B636">★</span>
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span>
                                              ...
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span>
                                              <span class="x_x_star-off" style="box-sizing:border-box; font-size:14px; color:#E1E6EA">★</span> 
                                              <span class="x_x_topic" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none; margin-left:10px">"""+str(star_1)+"""</span>
                                            </div>
                                          </td>
                                          <td class="x_x_content-cell x_x_words-cell" valign="top" style="border-collapse:collapse; box-sizing:border-box; font-size:14px; font-weight:500; width:40%; padding:0 20px">"""+', '.join(words)+""" </td>
                                          ...
                                          """+ str(range_df['Country'].value_counts(normalize=True).mul(100).round(1).astype(str) + '%'+"""<br>""").replace("Name: Country, dtype: object","")+"""
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
    ...
    recipient = ['pvani@ford.com','SKESHAV@ford.com','arajesh3@ford.com','SARAVI17@ford.com','psathis4@ford.com','FPIndiaLeadership@groups.ford.com','fpaccounts@groups.ford.com','ipm_in@groups.ford.com','TeamMaverick@groups.ford.com']
    for emailID in recipient:
      msg.make(
        new=k.recipient,
        with_properties={
            k.email_address: {
...
df1_final = [positive_reviews,negative_reviews,mixed_reviews]
df1_final = pd.concat(df1_final, ignore_index = True)
df1_final.reset_index(drop=True, inplace=True)
...
initial_date = today
email_date_format = f"{end_date.strftime('%d')} {end_date.strftime('%b')} - {initial_date.strftime('%d')} {initial_date.strftime('%b')} 2022"
...
mixedCount = range_df['sentiment'].value_counts()['Mixed']
...
logging.info("the mail is gonna call next")
send_mail()