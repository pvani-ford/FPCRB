...
def send_mail():
                                    ...
                                    <tbody style="box-sizing:border-box">
                                      <tr style="box-sizing:border-box">
                                        ...
                                        <td class="x_x_card-open-link" align="right" valign="top" style="border-collapse:collapse; box-sizing:border-box; white-space:nowrap; padding:20px 10px">
                                          <a href="http://19.39.78.32:8099/" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color:#C48C15!important; box-sizing:border-box; font-size:13px; font-weight:500; text-decoration:none" data-safelink="true" data-linkindex="2">Open in Dashboard(Ford VPN)</a> 
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
    ...
    msg.make(
        ...
        with_properties={
            # k.email_address: {
            #     # k.name: 'Priya Vani',
            #     k.address: 'ipm_in@groups.ford.com'
            #     },
            k.email_address: {
                # k.name: 'Priya Vani',
                k.address: 'pvani@ford.com'
                },
            k.email_address: {
                # k.name: 'Priya Vani',
                k.address: 'SARAVI17@ford.com'
                },
            k.email_address: {
                # k.name: 'Priya Vani',
                k.address: 'arajesh3@ford.com'
                },
            k.email_address: {
                # k.name: 'Priya Vani',
                k.address: 'SKESHAV@ford.com'
                },
            # k.email_address: {
            #     # k.name: 'Priya Vani',
            #     k.address: 'pvani@ford.com'
