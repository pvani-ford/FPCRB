...
def send_mail(positive_reviews, negative_reviews, total_reviews, avg_rating, star_1, star_2, star_3, star_4, star_5, words, date_format,mix_reviews):
    from redmail import outlook
    outlook.username = 'reviewsfp@outlook.com'

    outlook.password = 'AMVakf8y348qyfbi2#$'
    outlook.send(
    subject="Reporting Weekly Reviews - Android & iOS",
    sender="reviewsfp@outlook.com",    
    receivers="pvani@ford.com",
    html = """ 
    ...
    <body>
        <div>
          <div class="x_x_expired_banner" align="center" style="background:#461599; color:#ffffff; box-sizing:border-box; padding:30px">
                        ...
                        <tbody>
                                    ...
                                    <tbody style="box-sizing:border-box">
                                      <tr style="box-sizing:border-box">
                                        <td style="width:70px; border-collapse:collapse; box-sizing:border-box">
                                          <div class="x_x_grade-container" align="center" style="background-color:#088508; box-sizing:border-box; width:30px; height:30px; border-radius:40px; margin-left:10px; margin-top: 10px;padding:0">
                                          ...
                                          <div class="x_x_grade-container" align="center" style="background-color:#FFA500; box-sizing:border-box; width:30px; height:30px; border-radius:40px; margin-left:10px; margin-top: 10px;padding:0">
                                            <span class="x_x_grade" style="box-sizing:border-box; line-height:30px; color:#FFF; font-size:15px; font-weight:400">{{mix_reviews}}</span>
                                          </div>
                                          <div class="x_x_grade-container" align="center" style="background-color:#FF5D48; box-sizing:border-box; width:30px; height:30px; border-radius:40px; margin-left:10px; margin-top: 10px;padding:0">
                          ...
                          <tr style="box-sizing:border-box">
                            <td id="x_x_footer" colspan="2" align="center" style="font-size:11px; line-height:1.5; color:#000; border-collapse:collapse; box-sizing:border-box; padding:20px">
                              ...
                              <img data-imagetype="External" alt="" style="height:auto; line-height:100%; outline:none; text-decoration:none; box-sizing:border-box; border:0 none">
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
send_mail(positiveCount,negativeCount,totalCount,avgRating, star_1,star_2,star_3,star_4,star_5,words,email_date_format,mixedCount)
